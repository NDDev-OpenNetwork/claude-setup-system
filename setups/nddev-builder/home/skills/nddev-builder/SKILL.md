---
name: nddev-builder
description: Build, review or validate a Claude Code setup for claude-setup-system -- its owned surfaces, the components it carries, the lifecycle it performs, and the gate it must pass. Use when changing claude-setup-system or the native artifacts a setup writes.
---
