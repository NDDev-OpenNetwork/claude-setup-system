---
name: nddev-builder
description: Create, improve or review a complete Claude Code setup -- a native collection of tools for the user's tasks. Use for selecting and authoring components, composing setups, explaining their capabilities, adapting them to this harness, and validating installation and recovery through claude-setup-system.
---
